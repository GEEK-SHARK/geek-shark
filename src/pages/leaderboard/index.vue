    ...
    <div class="section">
        ...
        <ul>
            <li v-for="(item, index) in list" :key="index" class="rank-item">
                <span class="userinfo-rank" v-if="index==0"><img class="rank_img" src="../../../static/gold.jpg"/></span>
                <span class="userinfo-rank" v-if="index==1"><img class="rank_img" src="../../../static/silver.jpg"/></span>
                <span class="userinfo-rank" v-if="index==2"><img class="rank_img" src="../../../static/copper.jpg"/></span>
...
export default {
  ...
  data() {
    return {
      userInfo: {},
      list: [{
        avatarUrl: 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83eoD19gq63hC5nciceRnSAMkbwM0M8Q3AjG5bgTibKfqiafL6v0jb3EAQC0oVPEfibJmYdCGRtp30Svcsw/0',
        nickName: '吃雪怪君',
        worth: '1000.00万'
      }, {
        avatarUrl: 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83ervyMJ8rP0ialLQ50ZeeAYzZHskRia8QjgePdibaZciat3eK0icfh9uSnyUakXVpTEQg7ftNAXTKb6Sb6g/0',
        nickName: '金炳',
        worth: '970.00万'
      }, {
        avatarUrl: 'https://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEIu2y3ibpr0UiaTm6nib8GpEd7ecgLQBOibYNtzGXquA1KvicuESLhByv0OqLS7ASLsZoftjS6BG7UBMLw/0',
        nickName: '楼下小黑',
        worth: '890.50万'
      }, {
        avatarUrl: 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJ0iaMTicE4P8EdORX7zeMuLzUiabZvvkJynpdmvc7L5KHYd0UTWAPZhQNhsHIHicc3BDWXjDm9ueYTWA/0',
        nickName: 'W',
        worth: '789.50万'
      }, {
        avatarUrl: 'http://scimg.158pic.com/touxiang/201709/2017093023374596.jpg',
        nickName: '维城',
        worth: '600.50万'
      }, {
        avatarUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSe-Lo_jr4vafbd8jYB20ozb2at3hV3_ak3Ro7zU2RCJyRX4c41',
        nickName: '二削皮',
        worth: '539.50万'
      }],
      type: 0
